...
Activity.create(
  ...
  title: "Evening Run",
  sport: "run",
  date: "Sat, 23 Jun 2018 00:00:00 UTC -08:00",
  duration: 5640,
  distance: 4.23,
  elevation: 102.0,
  route_id: route16.id,
...
Activity.create(
  ...
  sport: "bike",
  date: "Fri, 08 Jun 2018 00:00:00 UTC -08:00",
  duration: 8400,
  distance: 3.53,
  elevation: 145.0,
  route_id: route4.id,
...
Activity.create(
  ...
  title: "Afternoon Ride",
  sport: "bike",
  date: "Sat, 12 May 2018 00:00:00 UTC -08:00",
  duration: 14880,
  distance: 7.53,
  elevation: 979.0,
  route_id: route12.id,
...
Activity.create(
  ...
  sport: "bike",
  date: "Sun, 20 May 2018 00:00:00 UTC -08:00",
  duration: 984033,
  distance: 7.0,
  elevation: 300.0,
  route_id: route2.id,
...
Activity.create(
  ...
  sport: "bike",
  date: "Sat, 19 May 2018 00:00:00 UTC -08:00",
  duration: 8700,
  distance: 7.75,
  elevation: 250.0,
  route_id: route6.id,
...
Activity.create(
  ...
  title: "Afternoon Ride",
  sport: "bike",
  date: "Sat, 09 Jun 2018 00:00:00 UTC -08:00",
  duration: 11100,
  distance: 10.91,
  elevation: 470.0,
  description: "",
...
Activity.create(
  ...
  title: "Afternoon Ride",
  sport: "bike",
  date: "Thu, 31 May 2018 00:00:00 UTC -08:00",
  duration: 4860,
  distance: 2.83,
  elevation: 150.0,
  route_id: route1.id,
...
Activity.create(
  ...
  title: "Evening Run",
  sport: "run",
  date: "Thu, 14 Jun 2018 00:00:00 UTC -08:00",
  duration: 150019,
  distance: 2.22,
  elevation: 38.0,
  route_id: route10.id,
...
Activity.create(
  ...
  sport: "run",
  date: "Sun, 03 Jun 2018 00:00:00 UTC -08:00",
  duration: 1500,
  distance: 2.22,
  elevation: 40.0,
  route_id: nil,
...
Activity.create(
  ...
  sport: "run",
  date: "Fri, 01 Jun 2018 00:00:00 UTC -08:00",
  duration: 2700,
  distance: 3.0,
  elevation: 39.0,
  route_id: nil,
...
Activity.create(
  ...
  title: "Morning Run",
  sport: "run",
  date: "Sun, 10 Jun 2018 00:00:00 UTC -08:00",
  duration: 228025,
  distance: 3.01,
  elevation: 439.0,
  route_id: route3.id,
...
Activity.create(
  ...
  title: "Morning Run",
  sport: "run",
  date: "Sun, 27 May 2018 00:00:00 UTC -08:00",
  duration: 246011,
  distance: 2.21,
  elevation: 229.0,
  route_id: route11.id,
...
user_id: demo.id,
 title: "Morning Ride",
 sport: "bike",
 date: "Fri, 15 Jun 2018 00:00:00 UTC -08:00",
 duration: 3960,
 distance: 4.8,
 elevation: 317.0,
 route_id: route17.id,
...
user_id: demo.id,
 title: "Morning Run",
 sport: "run",
 date: "Wed, 20 Jun 2018 00:00:00 UTC -08:00",
 duration: 1500,
 distance: 1.41,
 elevation: 373.0,
 route_id: route18.id,
