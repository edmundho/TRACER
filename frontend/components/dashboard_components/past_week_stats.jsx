  ...
  render () {
    ...
    return (
      <div id="weeks-stats">
        ...
        <ul>
          <li><p>Moving Time</p>{`${overallDuration.slice(0, 2)}h ${overallDuration.slice(3, 5)}m`}</li>
        ...
        <ul>
          <li><p>Moving Time</p>{`${ridesDuration.slice(0, 2)}h ${ridesDuration.slice(3, 5)}m`}</li>
        ...
        <ul>
          <li><p>Moving Time</p>{`${runsDuration.slice(0, 2)}h ${runsDuration.slice(3, 5)}m`}</li>
